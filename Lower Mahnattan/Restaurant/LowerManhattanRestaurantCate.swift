//
//  LowerManhattanRestaurantCate.swift
//  NewYorkTour
//
...
class LowerManhattanRestaurantCate: UIViewController, UITableViewDataSource,UITableViewDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "gotoYelpTable"
        {
            if let indexPath = tableView.indexPathForSelectedRow {
                guard let destination = segue.destination as? LowerManhattanRestaurant else { return }
                let category = categories[indexPath.row]
