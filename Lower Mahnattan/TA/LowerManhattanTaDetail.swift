//
//  LowerManhattanTaDetail.swift
//  NewYorkTour
//
//  Created by Taewook Noh on 2018. 5. 25..
...
class LowerManhattanTaDetail: UIViewController, UITableViewDelegate, UITableViewDataSource  {
    var taname:String?
    var tainfo:String?
    var talocation:String?
    var tahomepage:String?
    var openinghour = [String:AnyObject]()
    var name = ["Info","LocationDetail"]
    var placeID: String?
